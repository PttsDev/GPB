...
public class ChangePassword extends javax.swing.JFrame {
    ...
    private void changePasswordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changePasswordButtonActionPerformed
        ...
        if( cPw.length()<5 || cPw.length()>25 ) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Password lenght has to be between 5 and 25!", 
                    "Wrong input!", javax.swing.JOptionPane.ERROR_MESSAGE);
            
        }else if( cPw.equals(nPw) ){
          javax.swing.JOptionPane.showMessageDialog(this, "Passwords can't be the same!", 
                  "Wrong input!", javax.swing.JOptionPane.ERROR_MESSAGE);
